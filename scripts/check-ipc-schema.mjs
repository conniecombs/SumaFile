...
if (handlers.size !== 86) {
  fail(`expected 86 domain handlers, found ${handlers.size}`);
}
if (commands.domainMethodCount !== 86) {
  fail(`commands.json domainMethodCount must be 86, found ${commands.domainMethodCount}`);
}
