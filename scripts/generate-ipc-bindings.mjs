...
const wrappers = [
  ...
  { method: 'move_to_trash', signature: 'public Task MoveToTrashAsync(string[] paths, CancellationToken ct = default)', body: 'InvokeAsync<object?>(Protocol.MoveToTrashMethod, new { paths }, ct)' },
