...
const wrappers = [
  ...
  { method: 'remote_list_profiles', signature: 'public Task<RemoteProfile[]> RemoteListProfilesAsync(CancellationToken ct = default)', body: 'InvokeAsync<RemoteProfile[]>(Protocol.RemoteListProfilesMethod, new { }, ct)' },
  { method: 'remote_save_profile', signature: 'public Task<RemoteProfile> RemoteSaveProfileAsync(RemoteProfileInput profile, string? secret = null, CancellationToken ct = default)', body: 'InvokeAsync<RemoteProfile>(Protocol.RemoteSaveProfileMethod, new { profile, secret }, ct)' },
  { method: 'remote_delete_profile', signature: 'public Task RemoteDeleteProfileAsync(string profileId, CancellationToken ct = default)', body: 'InvokeAsync<object?>(Protocol.RemoteDeleteProfileMethod, new { profileId }, ct)' },
  { method: 'remote_test_profile', signature: 'public Task<RemoteConnectionTestResult> RemoteTestProfileAsync(RemoteProfileInput profile, string? secret = null, CancellationToken ct = default)', body: 'InvokeAsync<RemoteConnectionTestResult>(Protocol.RemoteTestProfileMethod, new { profile, secret }, ct)' },
  { method: 'remote_connect', signature: 'public Task<RemoteSession> RemoteConnectAsync(string profileId, string? secret = null, CancellationToken ct = default)', body: 'InvokeAsync<RemoteSession>(Protocol.RemoteConnectMethod, new { profileId, secret }, ct)' },
  { method: 'remote_disconnect', signature: 'public Task RemoteDisconnectAsync(string remoteSessionId, CancellationToken ct = default)', body: 'InvokeAsync<object?>(Protocol.RemoteDisconnectMethod, new { remoteSessionId }, ct)' },
  { method: 'remote_list_directory', signature: 'public Task<DirectoryListing> RemoteListDirectoryAsync(string remoteSessionId, string path, CancellationToken ct = default)', body: 'InvokeAsync<DirectoryListing>(Protocol.RemoteListDirectoryMethod, new { remoteSessionId, path }, ct)' },
  { method: 'remote_create_directory', signature: 'public Task<FileEntry> RemoteCreateDirectoryAsync(string remoteSessionId, string path, string name, CancellationToken ct = default)', body: 'InvokeAsync<FileEntry>(Protocol.RemoteCreateDirectoryMethod, new { remoteSessionId, path, name }, ct)' },
  { method: 'remote_rename_entry', signature: 'public Task<FileEntry> RemoteRenameEntryAsync(string remoteSessionId, string path, string newName, CancellationToken ct = default)', body: 'InvokeAsync<FileEntry>(Protocol.RemoteRenameEntryMethod, new { remoteSessionId, path, newName }, ct)' },
  { method: 'remote_delete_entries', signature: 'public Task<string[]> RemoteDeleteEntriesAsync(string remoteSessionId, string[] paths, CancellationToken ct = default)', body: 'InvokeAsync<string[]>(Protocol.RemoteDeleteEntriesMethod, new { remoteSessionId, paths }, ct)' },
  { method: 'remote_download_file', signature: 'public Task<string> RemoteDownloadFileAsync(string remoteSessionId, string remotePath, string localPath, CancellationToken ct = default)', body: 'InvokeAsync<string>(Protocol.RemoteDownloadFileMethod, new { remoteSessionId, remotePath, localPath }, ct)' },
  { method: 'remote_upload_file', signature: 'public Task<FileEntry> RemoteUploadFileAsync(string remoteSessionId, string localPath, string remotePath, CancellationToken ct = default)', body: 'InvokeAsync<FileEntry>(Protocol.RemoteUploadFileMethod, new { remoteSessionId, localPath, remotePath }, ct)' },
  ...
  { method: 'create_shortcut', signature: 'public Task<string> CreateShortcutAsync(string path, string name, string targetPath, string? arguments = null, string? workingDirectory = null, string? iconPath = null, CancellationToken ct = default)', body: 'InvokeAsync<string>(Protocol.CreateShortcutMethod, new { path, name, targetPath, arguments, workingDirectory, iconPath }, ct)' },
  ...
  { method: 'generate_thumbnail', signature: 'public Task<byte[]> GenerateThumbnailAsync(string path, uint size, CancellationToken ct = default)', body: 'InvokeAsync<byte[]>(Protocol.GenerateThumbnailMethod, new { path, size }, ct)' },
  ...
  { method: 'cancel_operation', signature: 'public Task<bool> CancelOperationAsync(string operationId, CancellationToken ct = default)', body: 'InvokeAsync<bool>(Protocol.CancelOperationMethod, new { operationId }, ct)' },
  ...
  { method: 'cancel_duplicate_check', signature: 'public Task CancelDuplicateCheckAsync(string? operationId = null, CancellationToken ct = default)', body: 'InvokeAsync<object?>(Protocol.CancelDuplicateCheckMethod, new { operationId }, ct)' },
