...
public sealed partial class MainWindow : Window
{
    ...
    public MainWindow()
    {
        ...
        _previewPresenter = new PreviewPresenter(
            ...
            PreviewMoreActionsButton,
            PreviewCompareMenuItem,
            PreviewChecksumMenuItem,
            PreviewOptionsPanel,
            PreviewRenderHtmlCheckBox,
            PreviewVideoPlaybackCheckBox,
            PreviewIconPanel,
            PreviewIconImage,
            PreviewIconLabel,
            PreviewImage,
    ...
    private void ApplyPrimaryToolbarOverflow()
    {
        ...
        layout.Normalize();
        var widths = ToolbarOverflowPlanner.PrimaryItemWidthsFor(toolbarWidth, layout);

        var overflowed = ToolbarOverflowPlanner.OverflowIds(
            toolbarWidth,
            reserved,
            widths,
            ToolbarOverflowPlanner.PrimaryHideOrderFor(layout));
    ...
    private void ApplyPrimaryOverflowVisibility(IReadOnlySet<string> overflowed)
    {
        ...
        ApplyPrimaryToolbarCommandVisibility(overflowed);
        SetOverflowVisible(ClosePrimaryPaneButton, false);
        var actionsVisible = HasVisiblePrimaryToolbarAction();
