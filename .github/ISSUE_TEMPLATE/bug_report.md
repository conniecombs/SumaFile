...
SumaFile is currently supported on Windows only. Please include the
...
| **SumaFile version** | <!-- e.g. 1.0.0 - check About dialog or release page --> |
...
<!-- Startup diagnostics: %LOCALAPPDATA%\SumaFile\startup.log -->
